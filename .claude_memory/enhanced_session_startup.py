...
class EnhancedSessionStartup:
    ...
    def __init__(self):
        ...
        self.perspectives = {
            'atlas': {'name': 'Atlas (Architect)', 'emoji': '🏗️', 'focus': 'System design & architecture'},
            'sherlock': {'name': 'Sherlock (Debugger)', 'emoji': '🔍', 'focus': 'Bug hunting & analysis'},
            'velocity': {'name': 'Velocity (Optimizer)', 'emoji': '⚡', 'focus': 'Performance & efficiency'}, 
            'guardian': {'name': 'Guardian (Tester)', 'emoji': '🛡️', 'focus': 'Quality assurance'},
            'sage': {'name': 'Sage (Documenter)', 'emoji': '📚', 'focus': 'Documentation & clarity'},
            'sentinel': {'name': 'Sentinel (Security)', 'emoji': '🔒', 'focus': 'Security & threats'},
            'echo': {'name': 'Echo (UX Advocate)', 'emoji': '👤', 'focus': 'User experience'},
            'mentor': {'name': 'Mentor (Guide)', 'emoji': '🎓', 'focus': 'Best practices & growth'}
        }
