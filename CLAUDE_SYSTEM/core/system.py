"""
CLAUDE.md Core System - Main Orchestrator
=========================================

This module contains the main system orchestration logic without the
massive implementation details that were in the monolithic version.
"""
